    ...
    <div class="">
        <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
            ...
            <a href="#" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="My Account">
                        <img src="/template/SocialMedia_files/avatar2.png" class="w3-circle" style="height:23px;width:23px" alt="Avatar">
                    </a>
        </div>
    </div>
        ...
        <div class="w3-row">
            ...
            <div class="w3-col m3">
                ...
                <div class="w3-card w3-round">
                    <div class="w3-white">
                        <button onclick="myFunction(&#39;Demo1&#39;)" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fas fa-circle-notch fa-fw w3-margin-right"></i> My Groups</button>
                        <div id="Demo1" class="w3-hide w3-container">
                            <p>Some text..</p>
                        </div>
                        <button onclick="myFunction(&#39;Demo2&#39;)" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fas fa-calendar-alt fa-fw w3-margin-right"></i> My Events</button>
                        ...
                        <div id="Demo3" class="w3-hide w3-container">
                            <div class="w3-row-padding">
                                <br>
                                <div class="w3-half">
                                    <img src="/template/SocialMedia_files/lights.jpg" style="width:100%" class="w3-margin-bottom">
                                </div>
                                <div class="w3-half">
                                    <img src="/template/SocialMedia_files/nature.jpg" style="width:100%" class="w3-margin-bottom">
                                </div>
                                <div class="w3-half">
                                    <img src="/template/SocialMedia_files/mountains.jpg" style="width:100%" class="w3-margin-bottom">
                                </div>
                                <div class="w3-half">
                                    <img src="/template/SocialMedia_files/forest.jpg" style="width:100%" class="w3-margin-bottom">
                                </div>
                                <div class="w3-half">
                                    <img src="/template/SocialMedia_files/nature.jpg" style="width:100%" class="w3-margin-bottom">
                                </div>
                                <div class="w3-half">
                                    <img src="/template/SocialMedia_files/fjords.jpg" style="width:100%" class="w3-margin-bottom">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w3-col m7">
                    ...
                    <div class="w3-col m12">
                        <div class="w3-card w3-round w3-white">
                            <div class="w3-container w3-padding">
                                <h6 class="w3-opacity">Social Media template by Chatbot</h6>
                                <p contenteditable="true" class="w3-border w3-padding">Status: Feeling Blue</p>
                                <button type="button" class="w3-button w3-theme"><i class="fas fa-pencil-alt"></i> &nbsp;Post</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    ...
                    <div class="w3-row-padding" style="margin:0 -16px">
                        <div class="w3-half">
                            <img src="/template/SocialMedia_files/lights.jpg" style="width:100%" alt="Northern Lights" class="w3-margin-bottom">
                        </div>
                        <div class="w3-half">
                            <img src="/template/SocialMedia_files/nature.jpg" style="width:100%" alt="Nature" class="w3-margin-bottom">
                        </div>
                    </div>
            ...
            <div class="w3-col m2">
                <div class="w3-card w3-round w3-white w3-center">
                    <div class="w3-container">
                        <p>Upcoming Events:</p>
                        <img src="/template/SocialMedia_files/forest.jpg" alt="Forest" style="width:100%;">
                ...
                <div class="w3-card w3-round w3-white w3-center">
                    <div class="w3-container">
                        ...
                        <div class="w3-row w3-opacity">
                            ...
                            <div class="w3-half">
                                <button class="w3-button w3-block w3-red w3-section" title="Decline"><i class="fas fa-times-circle"></i></button>
                            </div>
                        </div>
                    </div>
                </div>

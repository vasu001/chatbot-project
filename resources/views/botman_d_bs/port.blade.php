...
<body class="w3-black">
    ...
    <div class="w3-padding-large" id="main">
        ...
        <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
            ...
            <div class="w3-white">
                <div class="w3-red" style="height:28px;width:95%"></div>
            </div>
            ...
            <h3 class="w3-padding-16 w3-text-blue">My Price</h3>
                ...
                <div class="w3-half w3-margin-bottom">
                    <ul class="w3-ul w3-white w3-center w3-opacity w3-hover-opacity-off">
                        ...
                        <li class="w3-light-grey w3-padding-24">
                            <button class="w3-button w3-white w3-padding-large w3-hover-blue">Sign Up</button>
                        </li>
                    </ul>
                </div>
            ...
            <!-- Testimonials -->
            <h3 class="w3-padding-24 w3-text-blue">My Reputation</h3>
            <img src="/template/Portfolio_files/bandmember.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
            <p><span class="w3-large w3-margin-right">Someone-1</span> CEO at Mighty Schools.</p>
            <p>{{ $bot->name }} saved us from a web disaster.</p><br>

            <img src="/template/Portfolio_files/avatar_g2.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
            <p><span class="w3-large w3-margin-right">Someone-2</span> CEO at Company.</p>
            <p>No one is better than {{ $bot->name }}.</p>
            <!-- End About Section -->
        </div>

        <!-- Portfolio Section -->
        <div class="w3-padding-64 w3-content" id="photos">
            <h2 class="w3-text-blue">My Photos</h2>
            <hr style="width:200px" class="w3-opacity">

            <!-- Grid for photos -->
            <div class="w3-row-padding" style="margin:0 -16px">
                <div class="w3-half">
                    <img src="/template/Portfolio_files/wedding.jpg" style="width:100%">
                    <img src="/template/Portfolio_files/rocks.jpg" style="width:100%">
                    <img src="/template/Portfolio_files/sailboat.jpg" style="width:100%">
                </div>

                <div class="w3-half">
                    <img src="/template/Portfolio_files/underwater.jpg" style="width:100%">
                    <img src="/template/Portfolio_files/chef.jpg" style="width:100%">
                    <img src="/template/Portfolio_files/wedding.jpg" style="width:100%">
                    <img src="/template/Portfolio_files/p6.jpg" style="width:100%">
                </div>
                <!-- End photo grid -->
            </div>
        ...
        <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
            ...
            <p class="w3-medium">Powered by Chatbot &copy; 2018</p>
            <!-- End footer -->
        </footer>
